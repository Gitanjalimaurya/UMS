...
public class Admission {
	...
	@Column(name = "is_admission_filled", nullable = false)
	private boolean is_admission_filled = false;

	public Admission(String student_name, String father_name, String mother_name, Date date_of_birth, String religion, String gender, String house_no, String street_name, String city, String state, String country, String pin_code, byte[] student_image, String student_phone_no, String parent_phone_no, String studentEmail, String parent_email, String category, String high_school_board, int high_school_year_of_passing, float high_school_marks, String intermediate_board, int intermediate_year_of_passing, float intermediate_marks, String degree, String stream, String course, byte[] high_school_marksheet, byte[] intermediate_marksheet) {
	...
	public Admission(AdmissionDto admissionDto) {
	}
}
