...
public class AdmissionServiceImpl implements AdmissionService {
	...
	public void save(AdmissionDto admissionDto) throws IOException {
		...
		Optional<Admission> existingAdmission = admissionRepository.findByStudentEmail(admissionDto.getStudent_email());
		if (existingAdmission.isPresent()) {
			throw new IllegalArgumentException("Admission form already filled for this email.");
		}
		...
		admission.set_admission_filled(true);
		admissionRepository.save(admission);
	}

	@Override
	public Optional<Admission> findByEmail(String email) {
		return admissionRepository.findByStudentEmail(email);
	}
